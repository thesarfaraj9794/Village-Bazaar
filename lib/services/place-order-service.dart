...
import 'package:village_bazzar/services/genrate-order-id-service.dart';
  ...
  if (user != null) {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .get();
         // List<QuerySnapshot> documents =querySnapshot.docs.cast<QuerySnapshot<Object?>>();
      ...
      .doc(user.uid)
      .collection('cartOrders')
      .doc(doc.id)   // ✅ use doc.id, not productId
      .delete();
